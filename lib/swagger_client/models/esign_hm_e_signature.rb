...
module SwaggerClient
  ...
  class EsignHmESignature
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'esign')
        self.esign = attributes[:'esign']
      else
        self.esign = true
      end
      ...
      if attributes.has_key?(:'title')
        ...
        self.title = "Senior Hiring Manager"
      end
    ...
    def hash
      [esign, authorization, name, title].hash
    end
