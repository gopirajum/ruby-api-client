...
module SwaggerClient
  ...
  class PostDocument
    ...
    # The document code obtained from the documents list response.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'document_code')
        self.document_code = attributes[:'document_code']
      end
    ...
    def valid?
      ...
      return false if @document_code.nil?
    ...
    def hash
      [contents, document_code, document_type].hash
    end
